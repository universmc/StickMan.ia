...
async function executePromptingGroq() {
  try {
    const chatCompletion = await groq.chat.completions.create({
      messages: [
        { role: "system", content: "Using Groq to enhance API development workflows." },
        { role: "user", content: JSON.stringify(examplePrompt) },
        { role: "assistant", content: "Groq SDK actively generating actionable insights for the development process." }
      ],
      model: "gemma2-9b-it",
      temperature: 0.6,
      max_tokens: 1024
